...
Бот хранит на Volume не только идентификаторы объявлений, но и последнюю замеченную цену. Если цена уже известного объявления снижается, получатель получает отдельное уведомление со старой и новой ценой. При обновлении со старого формата кэша текущие цены запоминаются без ложных уведомлений.

...
- `📋 Мои запросы` — показывает личный список вместе с категориями;
- `➕ Добавить запрос` — спрашивает текст и позволяет отметить галочками одну или несколько категорий, включая автоматический подбор и `🌐 Все категории`, а затем добавить их одной кнопкой;
